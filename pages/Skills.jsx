...
export default function Skills() {
  return (
    <motion.div
      ...
      className='h-screen grid grid-rows-4 md:grid-rows-3 md:gap-2 grid-flow-col gap-4 justify-around items-end content-center overflow-hidden bg-[#464082] pb-4 text-center'>
      <div>
      ...
      <div>
        <BsWordpress className='reacticon bg-white rounded-full' />
        <h2>Wordpress</h2>
        <div className='flex justify-center star'>
          <Image src={Star} />
          <Image src={EmptyStar} />
