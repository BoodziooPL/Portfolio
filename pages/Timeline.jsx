      ...
      <div class='max-w-7xl mx-auto w-full grid grid-cols-9 px-2'>
        ...
        <div class='col-span-4 w-full h-full '>
          <div class='w-full h-full bg-indigo-400 rounded-md p-2 md:pl-4'>
            ...
            <p class='text-gray-100 sm:text-sm text-xs'>
              I Started learning on Udemy.com with courses samuraj programowania
              and others sources on youtube. I focused on getting more knowledge
              Javascript,RWD, API.
            </p>
          </div>
        </div>
        ...
        <div class='col-span-4 w-full h-full '>
          <div class='w-full h-full bg-indigo-400 rounded-md p-2 md:pl-4'>
            ...
            <p class='text-gray-100 sm:text-sm text-xs'>
            My main goal is to develop skills in security, penetration testing, and enhance my programming skills.
            </p>
          </div>
        </div>
        <div class='relative col-span-1 w-full h-full flex justify-center items-center'>
